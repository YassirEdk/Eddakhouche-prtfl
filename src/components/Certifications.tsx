...
const CertCard = ({ cert, index }: { cert: typeof certifications[0]; index: number }) => {
  ...
  return (
    ...
    >
      ...
      <Button variant="outline" size="sm" asChild className="gap-2 text-xs border-border/50 text-muted-foreground hover:bg-primary hover:border-primary hover:text-black dark:hover:text-white transition-all duration-200">
